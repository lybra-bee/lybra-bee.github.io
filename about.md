...
<div class="about-container">
  <div class="about-content">
    <div class="about-text">
      ...
      <div class="ai-experiment-notice neural-card-3d" style="background: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin-bottom: 25px;">
        <h4>🚀 Этот сайт — эксперимент по автоматической генерации контента</h4>
        ...
        <div class="experiment-stats" style="font-size: 0.9em; margin-top: 10px;">
          <strong>Статистика эксперимента:</strong>
