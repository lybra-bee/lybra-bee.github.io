...
def generate_image_horde(prompt, timeout=900):
    ...
    while time.time() - start_time < timeout:
        ...
        # Polling
        while time.time() - start_time < timeout:
            check_resp = requests.get(f"https://stablehorde.net/api/v2/generate/check/{task_id}", headers=headers)
            if check_resp.status_code == 200:
                ...
                if check_result.get("done"):
                    ...
                    if status_resp.status_code == 200:
                        ...
                        logging.info(f"Image generated by Horde: {img_path}")
                        return str(img_path)
                wait = check_result.get("wait_time", 5)
