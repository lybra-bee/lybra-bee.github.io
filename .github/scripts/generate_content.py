  ...
  generate:
    ...
    - name: Install Python dependencies
      run: |
        ...
        pip install requests python-slugify pyyaml Pillow
    ...
    - name: Commit generated content to main
      run: |
        ...
        git add content/posts/ assets/images/posts/ data/gallery.yaml
        git commit -m "📝 Сгенерирована новая статья и изображение [CI]" || echo "No changes to commit"
        git push
