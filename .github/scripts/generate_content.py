...
def generate_article():
    try:
        ...
        r = requests.post("https://openrouter.ai/api/v1/chat/completions",
            headers=headers,
            json={"model": "gpt-4o-mini", "messages":[{"role":"user","content":"Придумай заголовок о технологиях ИИ"}]})
        r.raise_for_status()
        ...
        r = requests.post("https://openrouter.ai/api/v1/chat/completions",
            headers=headers,
            json={"model": "gpt-4o-mini", "messages":[{"role":"user","content":f"Напиши статью 400 слов: {title}"}]})
        r.raise_for_status()
        ...
        return "Новая статья об ИИ", "Содержание статьи...", "Fallback"
...
def update_gallery(title, slug, image_path):
    ...
    try:
        ...
        logging.info(f"✅ Галерея обновлена")
    except Exception as e:
